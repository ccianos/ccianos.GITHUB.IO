...
<style>
    @font-face {
        ...
        font-style: normal;
        font-weight: 900;
        src: url(assets/fonts/bubblez_graffiti/BubblezGraffiti-Regular.ttf) format("truetype");
    }
    ...
    :root {
        ...
        --color-secondary: #ee6084; /* Jellyfish Sting (Coffee Shop Palette Color Palette https://www.color-hex.com/color-palette/13328) */
